...
type ButtonVariant = 'primary' | 'secondary' | 'outline-light' | 'text'
...
const variantClasses: Record<ButtonVariant, string> = {
  primary:
    'bg-navy text-white hover:bg-accent border border-navy hover:border-accent focus-visible:ring-accent',
  secondary:
    'bg-white text-navy border border-border hover:border-navy focus-visible:ring-accent',
  'outline-light':
